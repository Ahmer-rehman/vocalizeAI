...
const { WORK_DIR, convertTo16kMonoWav, validateAudioMetadata, chunkWavFile, transcribeToSrtSegments } = require("./services/transcribe");
...
app.listen(PORT, () => console.log(`Transcription pipeline running on http://localhost:${PORT}`));
